...
class getCandidateControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.x.q.bPs'] ?? $container->load('get_ServiceLocator_X_Q_BPsService'))->withContext('App\\Controller\\CandidateController', $container));
