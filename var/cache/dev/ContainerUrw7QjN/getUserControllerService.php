...
class getUserControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.WJzRlgB'] ?? $container->load('get_ServiceLocator_WJzRlgBService'))->withContext('App\\Controller\\UserController', $container));
